...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"src/lib/WC.js":[function(require,module,exports) {
"use strict";
...
exports.__WC_DEFAULT_PREFIX__ = exports.Register = exports.Component = exports.default = void 0;
...
var __WC_DEFAULT_PREFIX__ = "wc";
exports.__WC_DEFAULT_PREFIX__ = __WC_DEFAULT_PREFIX__;
...
function JSXRenderer(element, props) {
  for (var _len = arguments.length, children = new Array(_len > 2 ? _len - 2 : 0), _key = 2; _key < _len; _key++) {
    children[_key - 2] = arguments[_key];
  }

  if (typeof element === 'function') {
    return element(_objectSpread({}, props, {
      children: children
    }));
  } //console.log(element, props);


  var el = document.createElement(element); //console.log(el)
  ...
  if (props) {
    ...
    for (var _i = 0; _i < _arr.length; _i++) {
      var key = _arr[_i];
      var eventName = key.match(/^on([A-Z]\w+)$/);

      if (eventName) {
        el.addEventListener(eventName[1].toLowerCase(), props[key]); //el[eventName[0].toLowerCase()] = props[key];
...
function (_HTMLElement) {
  ...
  function Component() {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(Component).call(this)); //This is the shadow root, where you append everything
  ...
  _createClass(Component, [{
    ...
    value: function connectedCallback() {
      ...
      var el = this.render();
      if (typeof el === "string") this.ctx.innerHTML = el;else this.ctx.content.appendChild(el);
...
var Register = function Register(components) {
  return Object.keys(components).forEach(function (component) {
    var tokens = component.split(/([A-Z]\w+)/g).map(function (s) {
...
function (_HTMLElement) {
  ...
  function HelloWorld() {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(HelloWorld).call(this)); // Element functionality written in here
...
function (_HTMLElement) {
  ...
  function Component() {
    ...
    _this.context = document.createElement('div');

    _this.context.classList.add('root');

    _this.cssTextContent = "";

    _this.css = function (style_rules) {
      _this.cssTextContent += style_rules;
    }; //this.html = ``;
...
var _WC2 = _interopRequireWildcard(require("../lib/WC"));
...
function Counter() {
  ...
  var setState = function setState(handler) {
    state = handler(state);
  ...
  var Button = function Button() {
    var button = (0, _WC2.JSXRenderer)("button", {
      onClick: incrementCount
    }, state.count);
    mutators.push(function (state) {
      return button.innerText = state.count;
    });
    return button;
  };

  return (0, _WC2.JSXRenderer)("div", null, (0, _WC2.JSXRenderer)(Button, null));
}
...
function (_WC) {
  ...
  _createClass(_default, [{
    ...
    key: "render",
    value: function render() {
      this.styled(_templateObject());
      return (0, _WC2.JSXRenderer)("div", null, (0, _WC2.JSXRenderer)(Counter, null));
    }
  }], [{
...
var _WC = _interopRequireWildcard(require("../lib/WC"));
...
var Welcome = (0, _WC.JSXRenderer)("h1", null, "Hello there, my name is Ian Fabs");
Welcome.styled();
...
function (_Component) {
  ...
  _createClass(Home, [{
    key: "render",
    value: function render() {
      return (0, _WC.JSXRenderer)("div", null, Welcome, (0, _WC.JSXRenderer)("wc-test", {
        name: "Ian"
      }));
    }
  }]);
...
var _default = Home;
exports.default = _default;
},{"../lib/WC":"src/lib/WC.js"}],"src/pages/About.js":[function(require,module,exports) {
"use strict";
...
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
},{"./Home":"src/pages/Home.js","./About":"src/pages/About.js"}],"index.js":[function(require,module,exports) {
"use strict";

var _WC = require("./src/lib/WC");

require("./css/main.css");

var _HelloWorldWc = _interopRequireDefault(require("./src/components/HelloWorld.wc.js"));

var _CardWc = _interopRequireDefault(require("./src/components/Card.wc.js"));

var _NavBarWc = _interopRequireDefault(require("./src/components/NavBar.wc.js"));

var _RouterWc = _interopRequireDefault(require("./src/components/Router/Router.wc.js"));

var _Test = _interopRequireDefault(require("./src/components/Test.wc"));
...
customElements.define('hello-world', _HelloWorldWc.default);
customElements.define('blue-card', _CardWc.default);
customElements.define('blue-nav', _NavBarWc.default); //customElements.define('blue-test', Test);

customElements.define('blue-router', _RouterWc.default); //define pages

customElements.define('blue-page-home', _pages.Home);
customElements.define('blue-page-about', _pages.About); //Different methods for "rendering" that I came up with
...
//# sourceMappingURL=/vanillajs.e31bb0bc.js.map